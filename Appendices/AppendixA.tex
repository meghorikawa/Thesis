...
\begin{table}[h!]
    \centering
    \caption{Syntactic Complexity Features}
    \label{tab:appen-syntactic-complexity}
    \begin{tabular}{>{\raggedright\arraybacksplash}p{12cm}}
        \hline
        \textbf{Measure}\\
        \hline
Sentence Length\\
...
\begin{table}[h!]
    \centering
    \caption{Lexical Complexity Features}
    \label{tab:appen-lexical-complexity}
...
\begin{table}[h!]
    \centering
    \caption{Morphological Complexity Features}
    \label{tab:appen-morphological-complexity}
    \begin{tabular}{>{\raggedright\arraybackslash}p{12cm}}
        \hline
        \textbf{Measure}\\
        \hline
