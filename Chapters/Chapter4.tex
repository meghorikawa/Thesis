...
Five
grammar forms were selected for closer analysis based on their frequency and theoretical relevance:
...
between certain adjacent levels(e.g. N3-N2, N2-N1). Nonetheless, the large effect sizes observed between beginner
...
\hline
\end{tabular}
\caption{Raw frequency of Top 10 Forms extracted from the I-JAS Corpus}
...
\hline
\end{tabular}
\caption{Top 10 Grammar forms by normalized token ratio extracted from the I-JAS Corpus}
