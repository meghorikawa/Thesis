...
reliance of high-frequency vocabulary diminishes with proficiency. %TODO add citation comparing to nation's findings
...
\citep{Brezina2019} and JRMA based on the Korean Readability Morphological Analyzer\citep{Hwang2024}. These
...
specificity of JRMA (focusing on functions vs. content words), these metrics have stricter text length requirements,
...
\begin{figure}[htbp]
    ...
    \caption[Average JRMA MTLD all score across proficiency levels]{Average JRMA MTLD all(content and function) morphemes score across proficiency levels}
        \label{fig:MTLDall}
    \end{minipage}
    \hfill
\begin{minipage}{.48\textwidth}
        ...
        \caption[Average JRMA MTLD function morphemes score across proficiency levels]{Average JRMA MTLD function morphemes score across proficiency levels.}
...
For the JRMA MTLD calculation on the combined list of function and content words (JRMA\_all\_MTLD), 36 rows were removed
for not
...
\begin{figure}[htbp]
    ...
    \begin{minipage}{.48\textwidth}
        \centering
    \includegraphics[scale=.4]{img/JRMA-MTLDcontent.png}
...
\begin{minipage}{.48\textwidth}
        \centering
        \includegraphics[scale=.4]{img/JRMA-MATTRall}
        \caption[MATTR all]{}
\label{fig:MATTRall}
\end{minipage}
    \end{figure}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}{.48\textwidth}
        \centering
    \includegraphics[scale=.4]{img/JRMA-MATTRcontent.png}
...
%TODO include full chart in Appendix?
