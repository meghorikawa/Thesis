...
The Lexical Frequency Profile (LFP) was calculated using two different reference corpora: the Balanced Corpus of
...
LFP -BWCCJ Corpus
    ...
    * MANOVA revealed P value of Exact Wilks' Lambda p-value for JLPT 4.4492403847988e-133 meaning statistically
    significant difference exists between bands, Taking a closer look at the individual bands....
        *1k Band ->N5&N4, N5&N3, N1&NS, Percentage of vocab from 1k band decreases as proficiency increases.
        especially at teh higher proficiency level.
        *2K Bandin contrast to 1k band the 2k band sees increase in percent of vocab used across proficiency levels ,
...
LFP - JLPT WordList
    *percentage of N5 words slightly decreases across proficency levels to show higher learner's preference for
    vocbulary from the higher lists. Also N4 and N5 leves showed statistical significant difference between the
higher levels (N1 and N2). This measure also showed statistical different between native speaker and N1 group.
    *Just like with N5, significant difference between the lower ((N4, N5)) and higher (N1 and N2) proficency levels.
