...
\begin{figure}[htbp]
    ...
    \begin{minipage}{.48\textwidth}
        \centering
    \includegraphics[scale=.44]{img/sentence_len}
    \caption[The average Sentence Length]{The average Sentence Length across JLPT proficiency levels}
        \label{fig:sentLen}
    \end{minipage}
    \hfill
\begin{minipage}{.48\textwidth}
        ...
        \caption[The average clauses per sentence ratio]{The average ratio of clauses per sentence across JLPT proficiency levels}
\label{fig:cpersent}
\end{minipage}
    \end{figure}
...
\subsubsection{Clause-Based Measures (Including Coordination and Subordination)}
...
subordination with proficiency\citep{Vyatkina2012, Lu2010,Lu2011} has been commonly observed. However, in the present
data,
this trend was not
...
\begin{figure}[htbp]
    ...
    \caption[The average subordinate clauses to sentences ratio]{The average subordinate clauses to sentences ratio across JLPT proficiency levels}
        \label{fig:SubclperS}
    \end{minipage}
    \hfill
\begin{minipage}{.48\textwidth}
        ...
        \caption[The average subordinate clauses to clauses ratio]{The average subordinate clauses to clauses ratio across JLPT proficiency levels}
\label{fig:SCperC}
\end{minipage}
    \end{figure}
...
\begin{figure}[htbp]
    ...
    \caption[The average coordinate clauses to sentences across JLPT levels]{The average coordinate clauses to sentences across JLPT levels}
        \label{fig:CCperSent}
    \end{minipage}
    \hfill
\begin{minipage}{.48\textwidth}
        ...
        \caption[The average coordinate clauses to clauses ratio across JLPT levels]{The average coordinate clauses to clauses ratio across JLPT levels}
\label{fig:CCperCl}
\end{minipage}
    \end{figure}
...
\begin{figure}[htbp]
    ...
    \caption[The average Mean Dependency Distance]{The average Mean Dependency Distance (MDD) across JLPT proficiency levels. MDD increases slightly across levels, with significant differences between the higher proficiency levels.}
        \label{fig:mdd}
    \end{minipage}
    \hfill
\begin{minipage}{.48\textwidth}
        ...
        \caption[The average Mean Hierarchical Distance]{The average Mean Hierarchical Distance (MHD) across JLPT proficiency levels. The MHD increases consistently, distinguishing all adjacent proficiency levels.}
\label{fig:mhd}
\end{minipage}
    \end{figure}
...
distinguishing between adjacent levels in the lower proficiency range (Figure~\ref{fig:cttr}). No statistically
significant
differences were
...
\begin{figure}[h]
    ...
    \caption[The average Corrected Type-Token Ratio (CTTR)]{The average Corrected Type-Token Ratio (CTTR) across JLPT proficiency levels}
    \label{fig:cttr}
\end{figure}
...
The Measure of Textual Lexical Diversity (MTLD) was calculated for surface forms and lemmas. The
...
\begin{figure}[htbp]
    ...
    \caption[The average MTLD surface measure]{The average MTLD surface measure across JLPT proficiency levels}
        \label{fig:mtldS}
    \end{minipage}
    \hfill
\begin{minipage}{.48\textwidth}
        ...
        \caption[The average MTLD lemma measure]{The average MTLD lemma measure across JLPT proficiency levels}
\label{fig:mtldL}
\end{minipage}
    \end{figure}
...
\begin{figure}[htbp]
    ...
    \caption[The average noun density]{The average noun density across JLPT proficiency Levels}
        \label{fig:nounDen}
    \end{minipage}
    \hfill
\begin{minipage}{.48\textwidth}
        ...
        \caption[The average verb density ]{The average verb density across JLPT proficiency levels}
\label{fig:verbDen}
\end{minipage}
    \end{figure}
...
\begin{figure}[htbp]
    ...
    \caption[The average adjective density across JLPT Proficiency Levels]{The average Adjective density across JLPT proficiency levels}
        \label{fig:adjDen}
    \end{minipage}
    \hfill
\begin{minipage}{.48\textwidth}
        ...
        \caption[The average adverb density]{The averaage adverb density across JLPT proficiency levels}
\label{fig:advDen}
\end{minipage}
    \end{figure}
...
\begin{figure}[htbp]
    ...
    \caption[Distribution of average token percentages across 1k - 5k frequency bands]{Distribution of average token percentages across 1k - 5k frequency bands}
...
\begin{figure}[htbp]
    ...
    \caption[Average percentage of tokens from the BCCWJ Corpus 1k frquency band]{Average percentage of tokens from the BCCWJ Corpus 1k frequency band}
        \label{fig:1kband}
    \end{minipage}
    \hfill
\begin{minipage}{.48\textwidth}
        ...
        \caption[Average percentage of tokens from the BCCWJ Corpus 2k frquency band]{Average percentage of tokens from the BCCWJ Corpus 2k frquency band}
\label{fig:2kband}
\end{minipage}
    \end{figure}
...
\begin{figure}[htbp]
    ...
    \caption[Average percentage of tokens from the BCCWJ Corpus 3k frquency band]{Average percentage of tokens from the BCCWJ Corpus 3k frquency band}
        \label{fig:3kband}
    \end{minipage}
    \hfill
\begin{minipage}{.48\textwidth}
        ...
        \caption[Average percentage of tokens from the BCCWJ Corpus 4k frquency band]{Average percentage of tokens from the BCCWJ Corpus 4k frquency band}
\label{fig:4kband}
\end{minipage}
    \end{figure}
...
\begin{figure}
    ...
    \caption[Average percentage of tokens from the BCCWJ Corpus out of vocabulary (OOV) frquency band]{Average percentage of tokens from the BCCWJ Corpus out of vocabulary (OOV) frquency band}
    \label{fig:LFPOOV}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption[The percentage of tokens used from the JLPT N5 list]{The percentage of tokens used from the JLPT N5 list across JLPT proficiency levels}
...
\begin{minipage}{.48\textwidth}
        ...
        \caption[The percentage of tokens used from the JLPT N4 list]{The percentage of tokens used from the JLPT N4 list across JLPT proficiency levels}
...
\begin{figure}[htbp]
    ...
    \caption[The percentage of tokens used from the JLPT N3 list]{The percentage of tokens used from the JLPT N3 list across JLPT proficiency levels}
...
\begin{minipage}{.48\textwidth}
        ...
        \caption[The percentage of tokens used from the JLPT N2 list]{The percentage of tokens used from the JLPT N2 list across JLPT proficiency levels}
...
\begin{figure}
           ...
           \caption[The percentage of tokens used from the JLPT N1 list]{The percentage of tokens used from the JLPT N1 list across JLPT proficiency levels}
...
\citep{Brezina2019} and the Japanese Morphology Richness Analyzer (JMRA), based on the Korean Morphological Richness
Analyzer\citep{Hwang2024}. These
...
increase was observed across proficiency levels, with statistically significant differences between
...
\begin{figure}[htbp]
    ...
    \caption[The average MCI 5 surface scores]{The average MCI 5 surface scores across JLPT proficiency levels}
...
\begin{minipage}{.48\textwidth}
        ...
        \caption[The average MCI 5 inflection scores]{The average MCI 5 inflection scores across JLPT proficiency levels}
...
power was also limited to the lower levels otherwise (Figure~\ref{fig:MCI10inflection}).
...
\begin{figure}[htbp]
    ...
    \caption[The average MCI 10 surface scores]{The average MCI 10 surface score across JLPT proficiency levels}
...
\begin{minipage}{.48\textwidth}
        ...
        \caption[The average MCI 10 inflection scores across proficiency levels]{The average MCI 10 inflection scores across JLPT proficiency levels}
...
\begin{figure}[htbp]
    ...
    \caption[The average JMRA MTLD all score]{The average JMRA MTLD all(content and function) morphemes score across JLPT proficiency levels}
        \label{fig:MTLDall}
    \end{minipage}
    \hfill
\begin{minipage}{.48\textwidth}
        ...
        \caption[The average JMRA MTLD function morphemes score]{The average JMRA MTLD function morphemes score across JLPT proficiency levels.}
...
For the JMRA MTLD calculation on the combined list of function and content words (JMRA\_all\_MTLD), 36 texts were
removed
for not
...
\begin{figure}[htbp]
    ...
    \caption[The average JMRA MTLD content morpheme score]{The average JMRA MTLD content morphese score across JLPT proficiency levels}
...
\begin{minipage}{.48\textwidth}
        ...
        \caption[The average JMRA MATTR all morpheme score]{The average JMRA MATTR all morpheme score across JLPT proficiency levels}
\label{fig:MATTRall}
\end{minipage}
    \end{figure}
...
\begin{figure}[htbp]
    ...
    \caption[The average JMRA MATTR content morpheme score]{The average JMRA MATTR content morpheme score}
...
\begin{minipage}{.48\textwidth}
        ...
        \caption[The average JMRA MATTR function morpheme score]{The average JMRA MATTR function morpheme score across JLPT proficiency levels}
...
Overall, sentence length, coordinate clauses per sentence, mean dependency distance (MDD), mean
hierarchical
distance (MHD), corrected type-token ratio (CTTR),
BCCWJ-based LFP,
MCI-5 surface, and
JMRA
...
levels (JLPT N5 to Native Speaker), investigating their potential as 'criterial features' for assessing linguistic
development. As observed in previous research, (e.g., \citet{ Hawkins_Buttery_2010, akef2025}), the
absolute
...
acquisition. Such variability is expected in non-linear models of L2 development \citep{Verspoor2012,}, and does not
preclude these forms from serving as useful markers of proficiency.
...
Table~\ref{tab:CF-form-freq-ratio} provides their normalized frequencies (ratio of form to token count), which controls for
...
\caption[Heatmap of the top 5 grammar forms]{Heatmap of Dunn's post hoc p values for the top 5 grammar forms across JLPT levels, illustrating pairwise statistical significance}
\label{fig:CFheatmap}
\end{figure}
In
contrast, the
...
Figure~\ref{fig:CFheatmap}. Exceptions included N2-N1 and N3-N2, indicating a possible plateau or more nuanced
...
proficiency
groups (Figure~\ref{fig:CFplot}, Table~\ref{tab:CF-top6-per-level}). Its
use was
...
\hline
\end{tabular}}
\caption[The top 6 grammar forms by form-to-token ratio]{The top 6 grammar forms by form-to-token ratio across JLPT levels (selected seperately for each level)}
