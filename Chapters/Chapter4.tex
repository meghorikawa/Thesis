...
\end{figure}
In contrast, vocabulary from the 2k to 5k bands showed an updated trend in usage across proficiency levels. This
suggest a broadening of lexical range as learners become more advanced, even tough these bands contain fewer tokens
due to Zipf's law. From the 6k band onward, frequency of use dropped sharply across all bands, and no statistically
significant differnces were observed between levels. Due to their low useage and minimal disriminatory power, bands
6k through 10k were excluded from further analusis and visualization.
