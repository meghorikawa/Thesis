...
levels (JLPT N5 to Navtive Speaker), investigating their potential  as "criterial features" for assessing linguistic
...
Among beginner learners (N5 and N4), 「〜たい」(tai) was frequently used, as seen in Figure~\ref{fig:CFplot}. However, its
use gradually declined
with
increasing proficiency and was not statistically significant across groups($p$=0.5821), which confirmed by the lack of
...
requiring expressions of personal intent, preferences, or future plans (such as those in the I-JAS). Thus rather than
...
\label{fig:CFheatmap}
\end{figure}
%TODO add effect scores (Cliffs Delta for ordinal data)....
In
contrast, the
...
This suggests strong potential as a critical feature for tracking development in the lower to intermediate
...
「〜てくる」(tekuru), as aspectual form, demonstrated a steady increase in frequency across proficiency
levels, culminating in its most frequent use by the native speaker group. It was
...
discourse-pragmatic or spectral nuances such as expressing emotional change, backgrounding an action or event, or
temporal layering could require more advanced proficiency. This could be validated by a close analysis of the
outputs of the learners. %TODO include an analysis of the extracted forms
...
be applied to \citet{selinker1972} who emphasized that certain high-frequency forms exist in which learners rely on
in the earlier stages (referred to as Fossilized forms). Over time as proficiency increases the use of the form may
decrease as the interlanguage system of the learner expands and diversifies.

The conditional marker,「〜たら」(tara) appeared to plateau  around the intermediate levels (
N3). Despite this, it was still statistically significant across several non-adjacent groups, including N5-N3 and N4-N2,
...
more stable presence at intermediate stages rather than continuous growth.
...
work could also investigate the influence of genre of and the frequency of these grammar forms so that future corpus
design attempts can control for these tasks to extract specialized forms for further analysis.
