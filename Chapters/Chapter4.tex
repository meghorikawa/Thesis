...
In the BCCWJ-based LFP, words were grouped into 1,000 word frequency bands ranging for the most frequent (1k) to the
least frequent (10k), with an additional category for out-of-vocabulary (OOV) words. Unsurprisingly for all 5
proficiency levels the majority of vocabulary came from the 1k band(Figure~\ref{fig:percentBands}). A multivariate analysis of variance (
MANOVA)
confirmed that significant differences existed between JLPT levels (p<.001). When individual bands were examined the
1k Band showed a clear decrease in usage as proficiency increased, especially at higher levels(Figure~
...
In contrast, vocabulary from the 2k to 4k bands showed an updated trend in usage across proficiency levels. This
suggests a broadening of lexical range as learners become more advanced, even tough these bands contain fewer tokens
due to Zipf's law. 2k band could distinguish between nonadjacent levels N5-N3 and N4-N2,. 3k band also N5-N3, N4-N2.


From the 5k band onward, frequency of use dropped sharply across all bands, and no statistically
significant differences were observed between levels. Due to their low useage and minimal disriminatory power, bands
6k through 10k were excluded from further analysis and visualization.
...
Out-of-Vocabulary (OOV) items displayed a decreasing trend across proficiency levels. Statistically significant
differences were found not only at the lower levels (between N5 and N4, and N4-N3), but also at the higher end,
particularly between the N1 and Native speaker group. This pattern may reflect greater lexical control and fewer
errors among the advanced learners.
...
An alternative analysis using JLPT-aligned ocabulary lists provided agrees with the above observations. Words
classified as
N5-level appears frequently across all proficiency levels, but their relative use gradually declined as learners
advanced. While no significant differences were found among the beginner groups (N5 to N3), a significant shift
emerged between
N3 and N2, this indicates that the JLPT N5 vocabulary use may help distinguish between beginner and advanced learners(
Figure~\ref{fig:JLPTN5vocab})
. N4
level vocabulary showed a gradual increase across levels and then a decrease at N1(Figure~\ref{fig:JLPTN4vocab}).  Significant
differences
between N5 and N4 and again
between N4 and N3.
...
In contrast, N3 vocabulary use remained stable across all levels, with no statistically significant differences
detected (Figure~\ref{fig:JLPTN3vocab}). This suggests that words at this level do not meaningfully distinguish between proficiency
groups. N2-level vocabulary, however, showed steady growth and was able to significantly differentiate all levels
except the bottom two (N5 and N4) (Figure~\ref{fig:JLPTN2vocab}). Finally, N1-level vocabulary showed significance at
distinguishing
the lower levels (N5-N4, N4-N3), but failed to seperate higher proficiency groups. This could be due to the nature
of the vocabulary at the N1 level consisting of domain specific terms which due to the tasks limits the vocabulary
that could be used from this level.
