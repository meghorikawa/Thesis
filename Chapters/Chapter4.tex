...
task effect. This average length also seems to increase more significantly in the upper proficency levels compared
to the beginner levels.

Noun phrase length and verb phrase legnth in contrast, were less informative. NP length remained relatively stable
