...
Ebm- do not assume constant relatioships..

Interpret ml package used - train interpretable glassbox models.

remove identifying information i.e. loc, participant name, etc

keep some variables like L1, gender? to check for effect

participants language was also left in the data to observe any effect of these variables.

balance dataset via oversampling,train on interaction pairs between L1? for training
