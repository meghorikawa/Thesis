...
samples is presented in \ref{tab:participants-chart}.
...
\hline
\end{tabular}
\caption{\label{tab:participants-chart} A breakdown of participants per JLPT proficiency level. The J-cat proficency level has been mapped to JLPT level }
\end{table}
