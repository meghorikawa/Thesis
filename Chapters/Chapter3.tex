...
\begin{figure}[h!]
    ...
    \caption{\textbf{fig:text-lengths} The average text length across task and JLPT level. A detailed chart is
...
picture of learners' syntactic development. Global measures reflect on complexity at the sentence or clause level,
...
Due to the large size of the corpus, one of the main motivations for choosing these measures was the ease with which
they can be automatically calculated. For this reason, T-unit based measures-which require more complex and often
...
Further, subordinate and coordinate clauses per sentence are analyzed to distinguish different types of clausal
embedding. Subordinate clauses represent hierachical syntactic relationships (i.e. conditionals or complements),
while coordinate clauses connect clauses additively or sequentially. Together these provide insight into learners'
use of complex sentence structures. A method employed in \citep{Vyatkina2012} used
coordinating conjunctions and subordinating conjuctions as a proxy measure for coordination and subordination which
I will also explore.
...
due to ambiguity or structure \citep{UDJapanese}. Because of this, standard automatic annotation may not clearly
...
Overall, this set of global and local measures offers a comprehensive evaluation of syntactic complexity in learner
Japanese texts. It also highlights the difficulties in applying automated syntactic analysis to learner data in a
language like Japanese, which is morphosyntactically rich and often uses elliptical consturctions.

Global and local measures

Sent Length, Clauses per sentence,


Local measures: Noun phrase length,  Subordination, coordination, noun
clause length length, MDD, MHD
