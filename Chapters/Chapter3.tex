...
Each participant submitted up to six samples of writing for specific tasks:
\begin{itemize}
    ...
    \item A story telling format where the learner must write the narration to go along with a series of pictures.
    picnic theme. The sample pictures can be seen in \ref{fig:ST}
    \item A story telling format where the learner must write the narration to go along with a series of pictures.
    lost key theme.The sample pictures can be seen in \ref{fig:ST}
\end{itemize}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=.3]{img/ST.png}
    \caption[Story Telling Tasks]{Images used for the two story telling tasks. Learners were tasked with writing a narrative for the following images.}
    \label{fig:ST}
\end{figure}
