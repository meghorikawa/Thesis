...
sometimes involve sharp increases, plateaus, or even decreases in feature usage, patterns consistent with dynamic
systems
theory \citet{
Debot2007},language
development is nonlinear and dynamic. Decision trees can model nonlinear patterns, but are often unstable and prone to
overfitting, especially with imbalanced
datasets. EBMs strike a balance of being able to flexibiliy model nonlinear patterns while maintaining interpretable
...
To focus solely on L2 developmental patterns, the native speaker group (NS) was excluded. As it is also
one
of the
