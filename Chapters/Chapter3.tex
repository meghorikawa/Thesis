...
\section{EBMs}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Explainable Boosting Machines (EBMs) \citep{nori2019} are well-suited for langauge development research because of their ability to
capture
nonlinear
effects in a
transparent and interpretable manner. Unlike linear models, EBMs do not assume that feature effects remain constant
across the a continuous scale. This aligns with principles from Dynamic Systems Theory \citep{Debot2007}, which
proposes that L2 development is nonlinear and sensitive to multiple interacting influences.

% include example: certain features
%may not increase linearly, but may rise sharply and beginning
...
Only main effects were modeled (no pairwise interactions), prioritizing interpretability and avoiding overfitting
...
effects. The global explanation was then visualized to indentify and interpret the most influenctial features across
