...
\begin{figure}[h]
    ...
    \caption[J-Cat Proficiency Levels]{The assigned proficiency levels from the J-Cat test as taken from the original paper}
...
\hline
\end{tabular}
\caption[Proficency Levels]{Proficency level classification based on J-cat score. The JLPT equivalent of the score is given in
parenthesis.}
