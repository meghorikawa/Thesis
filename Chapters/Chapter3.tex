...
average length of word strings that maintain a minimum type=token ratio threshold, often ort at .72. A higher MTLD
score indicates a more diverse vocabulary.
...
To assess lexical sophistication, the Lexical Frequency Profile was implemented using two frequency based resources:
\itemize
\
%add MTLD formula%
...
the freq list ばいい is written but would be tokenized as ば　and いい ...to overcome this I used
tokenizer to split the verbs in the word list??

Also JLPT Word lists for LFP...
