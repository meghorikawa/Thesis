...
in figure \ref{fig:text_lengths}.
...
\begin{figure}[h!]
    ...
    \caption{\textbf{fig:text_lengths} The average text length across task and JLPT level. A detailed chart is
