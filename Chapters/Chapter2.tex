...
different domains such as, 'absolute vs relative'\citet{Miestamo2008}, 'linguistic' vs. 'cognitive' \cite{housen2009}, and 'absolute' vs. 'relative' \cite{Butle2012}. Of these the first term, is used to refer to characteristics of the linguistic system and the later for issues of cognitive demand for the speaker/learner sometimes simply reffered to as 'difficulty' which are usually invesitaged when analyzing readability. In readability studies measuring the complexity of a text and the cognitive demand for the ease someone may read it is done using various complexity measures.
