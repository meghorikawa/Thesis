...
on reference corpora to assess lexical frequency or sophistication \cite{Butle2012}.
...
length
\cite{koizumi2012}, more robust alternatives have been proposed, such as the correct type token ratio (CTTR)
\cite{Carroll1964}
and the Measure of Textual Lexical Diversity (MTLD) \cite{McCarthy2010}. MTLD calculates the average length of word
