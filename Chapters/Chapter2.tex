...
In terms of absolute (diversity-based) measures,Inflectional Diversity \citep{Malvern2004} simply tallies the
...
inflections-using
randomized resampling to control for sample size.  KMRA
\citep{Hwang2024} was introduced to take the unique agglutinative nature of Korean into consideration.
