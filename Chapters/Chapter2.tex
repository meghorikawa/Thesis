...
Historically, the majority of syntactic complexity research has focused on absolute measures, those
...
%    - include information on Japanese as an agglutinative language? refers to the range, diversity, and structural elaboration or morphemes in a
%learner's language production.
Just like
...
%maybe I should remove this as it isn't relevant to the study? I didn't use any of the measurements below.....
...
\cite{Iwashita2006} explored syntactic complexity in oral narratives from learners at different proficiency levels (three vs. four semesters of instruction). The study found increases in global length-based measures such as sentence
...
% how complexity measures are used in applications
% role of complexity measures in readability assessment
% Elaborate on use in Intelligent Computer-Assisted Language Learning (ICALL), adaptive learning, feedback, automated
% assessment.
% emphasize gap for Japanese
...
CTAP (Common Text Analysis Platform) \citep{ctap} is an open-source platform that supports the automatic
...
learners at
each
JLPT band were added after the revision in 2012. While the Japan Foundation does not publicly release official
evaluation criteria,
unofficial lists of grammar, vocabulary and Kanji have been compiled from the sample questions they release, as
well as from
practice workbooks that
...
%--- Talk about Challenes of APA - especially in 日本語!!!
...
These issues are particularly pronounced for morphologically rich and/or low-resource languages. For instance,
in Japanese, systems
often
...
% mention types of features EBMS could analyze in SLA context
