...
Similar to the focus of Syntactic complexity, Morphological complexity also focuses on measures of diversity and
    elaboration. Morph complexity has been less studied compared to lexical and syntactic complexity \citep(Bulte2012) -
possibly due
    to English's nature of not being as morphologically demanding compared to other languages?.Despite only a handful
of studies existing analyzing english, many studies for other languages exist, such as italian \citep{Pallotti2015},
French,
Japanese,
\citep{DeClercq2019}
\citep{Baerman2015}

\citep{Nishikawa2023} - non-native child acquisition of case markers in japanese
\citep{Tatsumi2018} -
...
complexity measures.
- not included in Bulte and House's taxonomy of ling. complexity
