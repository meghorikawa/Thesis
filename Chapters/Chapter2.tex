...
Phonetic Complexity - used mainly in comparing features across two different languages
Semantic - not included in \cite{Butle2012} framework, define measures it might focus on.
Discourse Complexity?
    Coherence and Cohesion
    -Coherence reader's mental representation of the text
    - Cohesion objective property of the text (COH metrix \citep{Graesser2004})
Discourse complexity refers to the degree of structural, semantic, and logical elaboration across larger units of
text, such as multiple sentences, paragraphs, or the whole text. One domain of evaluating discourse is coherence and
cohesion.
COH-METRIX \cite{Graesser2004} is an automated tool that analyzes the cohesion in written texts. It calculates over
100 indices including word and discourse features-focusing on cohesion, how well the ideas in a text are connected.
...
metrics such as sentence length-rather than clause-based units-have also shown strong discrimination betwee
proficency levels \citep{Ortega2003, Lu2011}.
...
development across proficency levels, suggessting a trajectory toward more hierarchically structured setnecens \citep{Ortega2003, Lu2011}.
