...
will analyze the different domains of linguistic complexity.
...
Syntactic complexity is concerned with quantifying how elaborate and varied the structures used in a text are. A text
containing more elaboration usually contains more parts, and is consequently longer, therefore length measures are the
standard measures used. \citet{Butle2012} further breaks this down into global and local levels of analysis. Global
