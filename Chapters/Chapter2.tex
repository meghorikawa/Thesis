...
example
of a lexical sophistication measure is the Lexical Frequency Profile introduced by \cite{Laufer1995}. Words in a
text would be compared against items in a frequency word list compiled from native speakers where the distribution of
vocabulary within the different frequency bands is analyzed. This offers insight on how native-like a learner's
vocabulary is by
evaluating how
common or
rare
the words used in
a learner's text are compared to native speakers usage.
