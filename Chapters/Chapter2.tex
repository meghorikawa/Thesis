...
written learner data \citep{Ortega2003,Lu2011}. However, other researches implementing automated systems have
preferred to use the sentences \citep{Vyatkina2012,Lu2010}. \citet{Bardovi-Harlig1992} also argued against
...
a text are categorized into three categories: function morphemes, content morphemes, and all-morphemes(bot function
and content).
Then, for
