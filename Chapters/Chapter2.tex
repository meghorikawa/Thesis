...
Many NLP-based systems have been designed to support language learning using complexity measures. These systems vary
...
analysis of linguistic complexity in texts.  It provides a flexible framework for extracting over 100 of linguistic complexity measures including from the syntactic , lexical,
and
...
main goal of CTAP is to facilitate comparive analysis of texts for second language learning
...
for studies, to identify and validate relevant linguistic complexity measures and criteria
...
%to do POLKE project add later if I can get a citation.
\citep{POLKE}
