...
mean word length, used as a proxy for lexical sophistication, and lexical density, which calculates the proportion
...
to cound the quality or "rarity" of words rather than density or diversity.  One
example
of this, is the Lexical Frequency Profile introduced by \cite{Laufer1995}.
