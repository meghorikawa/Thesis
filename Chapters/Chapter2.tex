...
readability judgments. \citet{crossley2014} showed that various indices of cohension and lexical sophistication
could effectively predic the comprehension difficulties that L2 readers face with expository texts. Both studies
show how quantitative complexity features can be leveraged to create more effective L2 learning resources.
