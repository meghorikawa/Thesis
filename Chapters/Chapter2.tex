...
While linguistic complexity focuses on the structural complexity and elaborateness, Criterial features as introduced
    in \citet{Hawkins_Buttery_2010} focus on the
    presence or
    absence of certain
    features in a learner's
    productions at different
    developmental stages. The intutition is that the use (or non-use) of these specific forms are indicative of L2
proficiency
at a
certain level. These features can include the use of certain grammar structures, lexical items, or morphosyntactic
forms shown to correlate to specific proficiency levels. Complexity measures are a continuous metric of elaboration
or variation in a text, while criterial features are more qualatative indicators that emerge or stabilize at distinct
stages of language development.

Criterial features may be analyzed within two dimensions: frequency and accuracy. Frequency, looks at the use of a
certain form across different levels to establish threshold points for development, whereas accuracy looks at the
correct usage (in comparison to native speaker's uses) of the forms across levels. For example, the use of passive
constructions may increase across proficiency levels but only consistent correct usage may appear from upper
intermediate levels and onwards. The dimension of accuracy can be helpful in distinguishing between emergence and
mastery stages.  \citet{Hawkins_Buttery_2010} outline 2 types of criterial features:  positive and negative.
Positive features are present at a certain level, but not before and therefore inform the emergence of a feature.
Negative features are features which are absent or forms that are used incorrectly, these features can show
development as errors diminish as learners master a form.


\citet{Hawkins_Buttery_2010} also found in their analysis of a learner corpus of English that, learner's who had a
first language which contained articles such as French, German, or Spanish, displayed a lower missing article error
rate than those whose L1 lacks articles. This supports the hypothesis that a learner's L1
influences the emergence and stabilization of article errors throughout proficency levels. This means that not all
criterial features may be universal markers, and their emergence could be influenced by a learner's L1. This
underscores a need for feature profiles which take a learner's background into consideration.

\citet{salamoura2010} alayzed learner texts in the Cambridge Learner Corpus (CLC) as part of the English Profile
Programme to identify forms whose use marks level attainment for the CEFR proficency levels. The decrease of
learner
errors and weakened influence of L1 was observed at the higher proficency bands.

\citet{tono2018,ishii2016} further pursued this to develop the CEFR-J

efforts and motivation for CEFR-J criterial
features

\citep{salamoura2010} findings

Write about the English Grammar Profile \citet{Saville2010} here and it's goal of
These forms have been found to mostly coencide with the CAN-DO
statements described in the CEFR framework\citep{CEFR2020}




POLKE project automated extraction of english features - work on portugese extraction
